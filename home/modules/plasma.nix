{
  programs.plasma = {
    ...
    configFile = {
      ...
      kwinrc."Tiling/d05da076-5b7f-46a2-9652-0c21ed9d3cfd/3f181b06-7738-4a02-9ba9-74a2f64dc225".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
